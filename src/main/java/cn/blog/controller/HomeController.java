...
import cn.blog.model.CommentDomain;
import cn.blog.model.ContentDomain;
import cn.blog.model.OptionsDomain;
import cn.blog.service.comment.CommentService;
import cn.blog.service.content.ContentService;
import cn.blog.service.meta.MetaService;
import cn.blog.service.option.OptionService;
import cn.blog.service.site.SiteService;
...
/**
 * 首页和关于我的页面控制器
 * Created by winterchen on 2022/4/28.
 */
@Api("网站首页和关于页面")
@Controller
...
//        this.blogBaseData(request,contentCond);//获取公共分类标签等数据
    ...
    public String index(
        ...
        request.setAttribute("common",options);
        return "site/index";
    }
